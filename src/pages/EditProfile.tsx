...
import { IonPage, IonHeader, IonToolbar, IonGrid, IonRow, IonCol, IonTitle, IonButton, IonContent, IonFab, IonFabButton, IonIcon, IonImg, IonText, IonList, IonItem, IonLabel, IonInput, IonAvatar, IonBackButton, IonButtons, IonThumbnail, IonProgressBar} from '@ionic/react';
